...
def isGueesRight(playerChoice,cpuChoice,trys):
    outputs={
        ...
        playerChoice != cpuChoice and trys >1 and cpuChoice - playerChoice <= 5 or cpuChoice - playerChoice <= -1 and cpuChoice - playerChoice >= -5: playerState.MISSFORMORE,
        playerChoice != cpuChoice and trys >1 and cpuChoice - playerChoice > 5 or cpuChoice - playerChoice < -5:playerState.MISSFORLESS,
...
class playerState(Enum):
    ...
    MISSFORMORE = "Wow are you Hot"
    MISSFORLESS = "Wow are you Cold"
